...
SRCS=./src/my_ip_country_detector.cpp ./src/my_server.cpp ./src/my_db.o ./src/my_torrent.o ./src/my_torrent_utils.cpp
OBJS= $(SRCS:.cpp=.o)
TARGET = main.out
...
main.out: ./src/my_ip_country_detector.o ./src/main.o ./src/my_server.o ./src/my_db.o ./src/my_torrent.o ./src/my_base_encode.o ./src/my_torrent_utils.o
	$(CC) -o $@ $^ $(LIBDIR) $(LIBS)
...
./src/my_torrent_utils.o: ./src/my_torrent_utils.cpp
	 $(CC) $(CFLAGS) $(INCDIR) -c $< -o $@
